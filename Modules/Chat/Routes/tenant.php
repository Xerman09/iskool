...
Route::prefix('chat')->middleware('auth')->group(function() {
    ...
    Route::post('settings', [UserController::class, 'settingsUpdate'])->name('chat.settings.update')->middleware('userRolePermission:chat.settings');
    ...
    Route::post('user/profile', [UserController::class, 'profileUpdate'])->name('chat.user.profile.update');
    ...
    Route::post('group/create', [GroupChatController::class, 'store'])->name('chat.group.create.store');
