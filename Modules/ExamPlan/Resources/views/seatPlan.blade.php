                            ...
                            @else
                                <div class="col-lg-4 mt-30-md">
                                    <select
                                        ...
                                        name="exam" id="exam">
                                        <option data-display="@lang('common.select_exam') *" value="">@lang('common.select_exam') *
                                        </option>
                                        ...
                                        <table class="table school-table-style" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="15%">
                                                        @if(moduleStatusCheck('University')) @lang('university::un.semester_label') @else @lang('common.class') @endif
                                                    </th>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="student.{{ $student->id }}"
                                                                @if (in_array($student->id, $seat_plan_ids)) checked @endif
                                                        ...
                                                        @if(moduleStatusCheck('University'))
                                                        <td>{{ $student->class != '' ? @$student->unSemesterLabel->name : '' }} ({{ '(' . $student->section != '' ? $student->section->section_name : '' . ')' }}) </td>
                                                        @else
