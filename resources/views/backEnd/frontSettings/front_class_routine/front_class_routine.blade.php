...
@section('title')
    @lang('front_settings.front_class_routine')
@endsection
@section('mainContent')
    <section class="sms-breadcrumb mb-20">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('front_settings.front_class_routine')</h1>
                <div class="bc-pages">
                    <a href="{{ route('dashboard') }}">@lang('common.dashboard')</a>
                    <a href="#">@lang('front_settings.frontend_cms')</a>
                    <a href="{{ route('front-class-routine') }}">@lang('front_settings.front_class_routine')</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if (isset($add_front_class_routine))
                            {{ Form::open([
                            ...
                            <input type="hidden" value="{{ @$add_front_class_routine->id }}" name="id">
                        @else
                            @if (userPermission('front-class-routine-store'))
                                {{ Form::open([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                        ...
                        <div class="white-box">
                            <div class="main-title">
                                <h3 class="mb-15">
                                    @if (isset($add_front_class_routine))
                                        @lang('front_settings.edit_front_class_routine')
                                    @else
                                        @lang('front_settings.front_class_routine')
                                    @endif
                                </h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input
                                                ...
                                                value="{{ isset($add_front_class_routine) ? @$add_front_class_routine->title : old('title') }}">
                                            @if ($errors->has('title'))
                                                    ...
                                                    <div class="col">
                                                        <div class="">
                                                            <input
                                                                ...
                                                                value="{{ isset($add_front_class_routine) ? date('m/d/Y', strtotime(@$add_front_class_routine->publish_date)) : date('m/d/Y') }}"
                                                                autocomplete="off">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <div class="primary_file_uploader">
                                                <input
                                                    ...
                                                    placeholder="{{ isset($add_front_class_routine) ? (@$add_front_class_routine->result_file != '' ? getFilePath3(@$add_front_class_routine->result_file) : trans('front_settings.result_file') . ' *') : trans('front_settings.result_file') . ' *' }}"
                ...
                <div class="white-box">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-15">@lang('front_settings.front_class_routine_list')</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <x-table>
                                <table id="table_id" class="table" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        @foreach ($frontClassRoutines as $key => $value)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ @$value->title }}</td>
                                                ...
                                                <td>
                                                    <x-drop-down>
                                                        ...
                                                        @endif
                                                        <a class="dropdown-item"
                                                            href="{{ route('front-class-routine-edit', @$value->id) }}">@lang('common.edit')</a>
                                                        <a href="{{ route('front-class-routine-delete-modal', @$value->id) }}"
                                                            class="dropdown-item small fix-gr-bg modalLink"
                                                            title="@lang('front_settings.delete_front_class_routine')" data-modal-size="modal-md">
                                                            @lang('common.delete')
                                                        </a>
                                                    </x-drop-down>
                                                </td>
