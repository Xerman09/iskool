                                                       ...
                                                       <div class="dropdown CRM_dropdown">
                                                           ...
                                                           <div class="dropdown-menu dropdown-menu-right">
                                                               ...
                                                               <!--  end CcAveune Gateway  -->
                                                                    ...
                                                                    @if(moduleStatusCheck('PhonePay') && $balance_amount !=0)
                                                                    <!-- start PhonePay Gateway  -->
                                                                       ...
                                                                       @endphp
                                                                                ...
                                                                                <form method="POST" action="{{ route('studentFeesPay-PhonePe') }}" accept-charset="UTF-8" class="form-horizontal" role="form">
                                                                                    ...
                                                                                    <button type="submit" class=" dropdown-item"
                                                                                    @if(serviceCharge('PhonePe'))
                                                                                        data-toggle="tooltip" data-title = "{{ __('common.service charge for per transaction ') }} {{ serviceCharge('PhonePe') }}"
                                                                                    @endif
                                                                                    >
                                                                                        @lang('fees.PhonePe')
                                                                                        {{ serviceCharge('PhonePe') ? '+'.serviceCharge('PhonePe') : '' }}
                                                                                    </button>
                                                                                </form>
