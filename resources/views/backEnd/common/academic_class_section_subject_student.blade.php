...
<div class="{{ $div . ' ' . $mt }}">
    <div class="primary_input ">
        <select class="primary_select  form-control{{ $errors->has('academic_year') ? ' is-invalid' : '' }} common_academic_year"
...
<div class="{{ $div . ' ' . $mt }}" id="common_select_class_div">
    <select class="primary_select form-control {{ $errors->has('class') ? ' is-invalid' : '' }}" id="common_select_class"
        name="class_id">
