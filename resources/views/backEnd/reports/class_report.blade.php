        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="white-box">
                    ...
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'class_reports', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                        <div class="row">
        ...
        <div class="white-box mt-40">
            <div class="row">
                <div class="col-lg-4 no-gutters">
                    <div class="main-title">
                        <h3 class="mb-15">@lang('reports.class_report_for_class') {{@$search_class->class_name}}, {{$sectionInfo != ""? 'section ('. $sectionInfo->section_name.')': ''}}</h3>
                    </div>
                </div>
            </div>
            <div class="row">
