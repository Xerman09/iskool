...
<html lang="en">
<head>
  <title>@lang('exam.progress_card')</title>
  <meta charset="utf-8">
...
<div class="container"> 
        ...
        <h4 style=" text-align: center;  padding: 10px;">@lang('exam.student_progress_card')</h4> 
              ...
              <thead>
                ...
                <tr>
                    ...
                    <td colspan="2">{{ $subject->subject_name }} </td>
                     @endforeach
                <td rowspan="{{ $assign_subjects->count()+11}}" > @lang('exam.gpa') </td>
                </tr>
              </thead>
              <tbody>
                <tr>
