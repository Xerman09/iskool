@php
    ...
    $copyright_text = 'Copyright 2024 All rights reserved by eSkooly Inc.';
    }
@endphp
...
@if(config('app.app_sync'))
    ...
    <a href="#buy" product-code="HGFM41A4ZM" product-quantity="1" class="float_button avangate_button"> <i class="ti-shopping-cart-full"></i>
        <h3>Purchase eSkooly</h3>
    </a>
@endif
