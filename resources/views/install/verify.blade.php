...
<head>
    ...
    <title>eSkooly Pro ERP | Verify Your purchase </title>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="justify-content-center">
                    <p class=" text-red purchase-alert">If you are using our system without purchase, Please contact with us at <a target="_blank" href="mailto:support@eskooly.com">support@eskooly.com</a>.</p>
                    ...
                    <form method="POST" action="{{url('system-verify')}}" class="mt-40">
                        ...
                        <div class="form-group">
                            <label for="user">eSkooly Registered Email :</label>
                            <input type="text" class="form-control " name="envatouser"  required="required"  placeholder="eSkooly Registered Email" value="{{old('envatouser')}}">
                        </div>
                        <div class="form-group">
                            <label for="purchasecode">eSkooly Serial Key:</label>
                            <input type="text" class="form-control" name="purchasecode" required="required" placeholder="eSkooly Serial Key" value="{{old('purchasecode')}}">
                        </div>
                        <div class="form-group">
