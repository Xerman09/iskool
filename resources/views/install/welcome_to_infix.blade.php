...
<head>
    ...
    <link rel="alternate" href="http://pro.eskooly.com" hreflang="en-us" />
    <title>eSkooly Pro school management software & School management system</title>
        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to eSkooly Pro </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing eSkooly Pro for your school administration. Please follow the steps to complete eSkooly Pro installation!</p>
