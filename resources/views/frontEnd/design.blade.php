                        ...
                        <tr>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field" type="text" placeholder="Enter Room Number" name="monday_room" value="{{isset($class_routine->monday_room_id)? $class_routine->monday_room_id:''}}">
                            ...
                            <td>
                                <div class="row">
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field" type="text" placeholder="Enter Student No" name="monday_room" value="{{isset($class_routine->monday_room_id)? $class_routine->monday_room_id:''}}">
