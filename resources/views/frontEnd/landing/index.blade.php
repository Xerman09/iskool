...
<head>
 ...
 <title> eSkooly school management software & School management system </title>
<meta name="description" content="eskooly pro is 100+ unique feature enable school management software system. It can manage all type of school, academy and any educational institution. ">
...
[ {
  ...
  "name" : "eskooly pro - Best School Management software system",
  "url" : "http://eskoolypro.com/",
  "author" : {
    "@type" : "Company",
    "name" : "Spondon IT"
  },
  ...
  "downloadUrl" : "http://eskoolypro.com",
  "operatingSystem" : "2019",
  "requirements" : "in a complete",
  "screenshot" : "http://eskoolypro.com/public/landing/img/dashboard_preview.png",
  "softwareVersion" : "2.0",
  ...
  "review" : {
    ...
    "reviewBody" : "Query\n                                Account"
        ...
        <meta name="twitter:site" content="@eskoolypro"/>
        <meta name="twitter:creator" content="@eskoolypro"/>
        <meta name="twitter:url" content="//eskooly pro.com/"/>
        <meta name="twitter:title" The Ultimate Education Management System For School,  Institute & Academy"/>
        <meta name="twitter:description" content="eskooly pro is a well known School management system and its ERP based Software. So try the free demo today!. Cause eskooly pro offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
        <meta property="og:image" content="http://eskoolypro.com/public/landing/img/dashboard_preview.png"/>


        <!-- Open Graph data -->
        <meta property="og:type" content="website" />
        <meta property="og:url" content="//eskoolypro.com/"/>
        <meta property="og:image" content="//eskoolypro.com/public/landing/img/dashboard_preview.png"/>
        <meta property="og:title" content="School Management ERP Software & School Management System - eskooly pro"/>

        <meta property="og:description" content="eskooly pro is a well known School management system and its ERP based Software. So try the free demo today!. Cause eskooly pro offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
        <meta property="og:site_name" content="eskooly pro" />

    <link rel="canonical" href="http://eskoolypro.com" hreflang="en-us" />
                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Managing various administrative tasks in one place is now quite easy and time
                                savior with this eskooly pro and Give your valued time to your institute that will
                                increase next generation productivity for our society.</p>
                            @if(!moduleStatusCheck('Saas'))
                            <a  class="btn_1" target="_blank" href="mailto:support@eskooly.com?subject=Request for saas school demo!&body=This is only a test!"> <i class="ti-email"></i> For Saas Demo</a>
                            @endif
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <!-- <a class="btn_1 d-none d-lg-block" target="_blank" href="http://salespanel.eskoolypro.com/">Purchase</a> -->
                        <a class="btn_1 d-none d-lg-block" target="_blank" href="https://pro.eskooly.com.com">Purchase</a>
                    </nav>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>eskooly pro has all in one place. You’ll find everything what you are looking into education
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>You know! Smart Idea always comes to well planners. And Our eskooly pro is Smart for its Well
                                Documentation.
                            </p>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="video_section_text">
                        <h2>Take A look Our eskooly pro Overview in Video</h2>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-8">
                    <div class="section_tittle text-center">
                        <h5>AMazing Features</h5>
                        <h2>More Features Has eskooly pro</h2>
                        <p>it's vast! eskooly pro has more additional feature that will expect in a complete solution.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
    ...
    <section class="contact_us padding_top" id="Support">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-md-8">
                    <div class="section_tittle text-center">
                        ...
                        <h2>eskooly pro Support Centre</h2>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <a href="https://ticket.eskooly.com/help-center" target="_blank">
                        <div class="single_feature">
                            <div class="single_feature_part">
                ...
                <div class="col-md-6">
                    <a class="support-link" target="_blank" href="https://ticket.eskooly.com/eskoolypro">
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><i class="ti-write"></i></span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <p>We Believe! It won’t a wrong decision in Purchasing our eskooly pro for your Institute.</p>
                        <!-- <a href="http://salespanel.eskoolypro.com/" class="footer_btn"> <i class="ti-shopping-cart-full"></i> -->
                        <a href="https://eskooly.com" target="_blank" class="footer_btn"> <i class="ti-shopping-cart-full"></i>
                            <h3>Purchase eskooly pro</h3>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="copyright_text"> 
                        <p> <img src="{{asset('public/landing/img/copyright.svg')}}" alt="#"> 2019-2020 eskoolypro - Ultimate Education ERP. All Rights
                            Reserved to <a href="#">eskooly </a> .</p>
                    </div>
                </div>
            </div>
        </div>
...
<script src="https://swc.cdn.skype.com/sdk/v1/sdk.min.js"></script>-->
    ...
    <a class="whatsApp_icon" style="background-color: #359334" href="https://wa.me/+923460204447" target="_blank">
