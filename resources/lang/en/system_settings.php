<?php 
    return [
        ...
        'dashboard_logo_hint'=> 'Shown on the dashboard sidebar only - use a white/light version if your sidebar has a dark background. Falls back to the main logo if not set.',
        'change_login_logo'=> 'Change Login Logo',
        'login_logo_hint'=> 'Shown on the login page only. Falls back to the main logo if not set.',
        'change_letterhead_logo'=> 'Change Letterhead Logo',
        'letterhead_logo_hint'=> 'Used on printed documents and invoices instead of the main logo. Falls back to the main logo if not set.',
        'upload'=> 'Upload',
