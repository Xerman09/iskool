...
trait SidebarDataStore
{
    ...
    function resetSidebarStore()
    {
        ...
        $administration_sections = ["admin_section", "academics", "enroll", "store-section", "university_setup", "study_material", 'download-center', "lesson-plan", "bulk_print","certificate","university","lms"];
