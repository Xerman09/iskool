...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!$exists) {
            DB::table('permissions')->insert([
                ...
                'parent_route' => 'enroll',
                'type' => 2,
                'lang_name' => 'academics.my_schedule',
                'icon' => null,
                'status' => 1,
                'menu_status' => 1,
                'position' => 19,
        ...
        $roleId = 2; // Student
        $schoolId = 1;
        $permissionId = DB::table('permissions')->where('route', 'student-my-schedule')->value('id');
    ...
    public function down(): void
    {
        ...
        DB::table('permissions')->where('route', 'student-my-schedule')->delete();
    }
};
