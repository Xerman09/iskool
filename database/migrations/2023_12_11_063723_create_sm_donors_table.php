...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $datas = [
            ['Mudassar Bajwa', 'Doctro', date("Y-m-d", strtotime('1990-12-12')), "mudassar@eskooly.com", '+923460204447', $bloodgroup->id, $religion->id, $gender->id],
            [' Md Mohsin ', 'Farmer', date("Y-m-d", strtotime('1993-08-05')), "mohsin@eskooly.com", '+923460204447', $bloodgroup->id, $religion->id, $gender->id],
            ['Md Adam', 'Engineer', date("Y-m-d", strtotime('1990-12-12')), "adam@eskooly.com", '+923460204447', $bloodgroup->id, $religion->id, $gender->id],
        ];
        ...
        foreach($datas as $key => $data){
            ...
            $storeData->current_address = "Manchester, UK";
            $storeData->permanent_address = "Manchester, UK";
